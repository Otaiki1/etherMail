  ...
  return (
    <div className="relative bg-white w-full h-[51.81rem] overflow-hidden text-center text-[2.5rem] text-white font-lato">
      ...
      <div className="absolute top-[12.19rem] left-[31.44rem] rounded-3xs bg-whitesmoke shadow-[0px_0px_10px_rgba(255,_255,_255,_0.2)] w-[27.19rem] h-[34rem] overflow-hidden text-[1.25rem]">
        ...
        <div
          className="absolute top-[21.94rem] left-[1.5rem] rounded-3xs bg-gray-100 w-[10.63rem] h-[4.13rem] cursor-pointer"
          onClick={onRectangle3Click}
        />
        <button className="cursor-pointer p-0 bg-white absolute top-[21.94rem] left-[14.88rem] rounded-3xs box-border w-[10.75rem] h-[4.25rem] border-[1px] border-solid border-gray-100" />
        <img
        ...
        />
        <b className="absolute top-[23.25rem] left-[5.88rem]">Yes</b>
        <b className="absolute top-[23.31rem] left-[19.44rem] text-black">No</b>
        <b className="absolute top-[14.44rem] left-[5.31rem] text-gray-500">
          <p className="m-0">Recipient is yet to claim token</p>
          <p className="m-0">Do you want to cancel</p>
